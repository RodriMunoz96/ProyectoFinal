      ...
      <Row>
        <Col md={3} lg={2} style={{ backgroundColor: '#0b4c7b' }} className=" sidebar">
          <Nav className="flex-column">
            ...
            <Link onClick={() => navigate('/admin/crearadmin')}>Inicio</Link>
            {/* CONTENIDO ADMIN */}
            <Link to="/admin/crearadmin">Crear un Admin</Link>
            <Link to="/Inicio/Admin/Modificar">Modificar un Admin</Link>
            <Link to="/Inicio/Admin/Admin">Eliminar un Admin</Link>
            <Link to="/Inicio/Admin/VerTodos">Ver todos los Admin</Link>
            {/* CONTENIDO PADRE */}
